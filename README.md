...
### CelebAMask-to-FFHQ
Train LSA encoder and regressor for CelebAMask-HQ mask domain, with StyleGAN2-FFHQ as the generator backbone. 
...
### Sketch-to-FFHQ
Train LSA encoder and regressor for CUFSF facial sketch domain, by using StyleGAN2-FFHQ as the generator backbone. 
